...
cases. For example, "Dad" passed into the function should return 1 as "d"
and "D" are duplicates.
...
def count_consonants(text):
    ...
    vowels = "aeiou"
    sorted_text = [char for char in sorted(text)
                   if char.isalpha() and char not in vowels]
    return len(set(sorted_text))
